...
const TEMPLATE_ICON: Record<TemplateSlug, typeof Zap> = {
  ...
  sales_autopilot: Rocket,
  real_estate_followup: Home,
  ecommerce_cart: ShoppingCart,
  coaching_inquiry: GraduationCap,
  agency_lead: Building2,
}
...
export default function AutomationsPage() {
  ...
  const showTemplates = automations.length < 5
