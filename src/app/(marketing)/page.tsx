...
import { FullCapabilities } from "@/components/landing/full-capabilities";
import { PlatformTools } from "@/components/landing/platform-tools";
import { MetaIntegration } from "@/components/landing/meta-integration";
...
export default function HomePage() {
  return (
    <div className="space-y-24 pb-20 overflow-x-hidden bg-slate-950 text-slate-100 selection:bg-blue-500/30 selection:text-white">
      ...
      {/* ==========================================
          1. HERO SECTION (Redesigned Left-Right Layout)
         ========================================== */}
      <section className="relative pt-12 md:pt-20 lg:pt-32 px-4 max-w-7xl mx-auto">
        {/* Background Glows */}
        <div className="absolute top-12 left-10 w-[350px] h-[350px] bg-blue-600/10 blur-[130px] rounded-full pointer-events-none -z-10" />
        <div className="absolute top-20 right-10 w-[450px] h-[450px] bg-purple-600/5 blur-[150px] rounded-full pointer-events-none -z-10" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 xl:gap-12 items-center">
          ...
          <div className="lg:col-span-4 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            {/* Hero Title */}
            <h1 className="text-3xl sm:text-4xl lg:text-4xl xl:text-5xl font-extrabold tracking-tight text-white leading-[1.15]">
              More Leads.<br />Faster Follow-Up.<br />
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <Link
                href="/book-demo"
                className="w-full sm:w-auto text-center font-semibold text-white bg-blue-600 hover:bg-blue-500 px-6 py-3.5 rounded-xl shadow-[0_0_25px_rgba(37,99,235,0.35)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] transition-all flex items-center justify-center gap-2 group text-sm"
              >
              ...
              <a
                href="#features"
                className="w-full sm:w-auto text-center font-medium text-slate-300 hover:text-white px-6 py-3.5 rounded-xl border border-slate-800 hover:border-slate-700 hover:bg-slate-900/40 transition-all text-sm"
              >
                See How It Works
              </a>
            </div>
          ...
          <div className="lg:col-span-8 w-full">
            <div className="w-full rounded-2xl border border-slate-900 bg-slate-900/10 p-2 shadow-2xl relative group">
                    ...
                    <div className="flex-1 overflow-y-auto px-2 space-y-0.5 custom-scrollbar">
                      {[
                        ...
                        >
                          ...
                          {item.hasChevron && <ChevronRight className="h-3 w-3 text-slate-500" />}
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="flex-1 p-4 grid grid-cols-12 gap-4 overflow-y-auto custom-scrollbar">
                      ...
                      <div className="col-span-12 lg:col-span-5 bg-[#0d1222]/60 border border-slate-900/80 rounded-xl p-4 flex flex-col justify-between">
                        ...
                        <div className="flex-1 flex flex-col justify-between min-h-[140px] pt-4">
                          <div className="flex-1 flex items-slate-stretch gap-2.5 relative">
                            {/* Y-Axis */}
