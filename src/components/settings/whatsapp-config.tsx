...
export function WhatsAppConfig() {
  ...
  async function handleMetaEmbeddedSignup() {
    // Mock the Meta Embedded Signup Flow
    setMetaLinking(true);
    toast.info("Opening Meta secure login...", { duration: 2000 });
    ...
    setTimeout(() => {
      ...
      toast.success("Successfully linked with Facebook! Click Save Configuration to apply.");
    }, 3000);
  }
        ...
        <Card className="bg-slate-900 border-slate-700 ring-0 ring-transparent">
          <CardHeader className="flex flex-row items-start justify-between pb-4">
            ...
            <Button 
              ...
              className="bg-[#1877F2] hover:bg-[#1877F2]/90 text-white shrink-0 shadow-lg shadow-blue-900/20"
            >
              {metaLinking ? (
              ...
              {metaLinking ? "Connecting..." : "Connect with Facebook"}
            </Button>
          </CardHeader>
