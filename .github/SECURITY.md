...
- [GitHub Security Advisories](https://github.com/Ashishkrji/MJChatSyncs/security/advisories/new)
...
In scope:
- Anything in this repository (`Ashishkrji/MJChatSyncs`), including webhook and auth
